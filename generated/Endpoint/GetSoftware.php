...
class GetSoftware extends \ExtraHop\Api\Runtime\Client\BaseEndpoint implements \ExtraHop\Api\Runtime\Client\Endpoint
{
    protected $id;
    /**
     * 
    ...
    {
        return str_replace(array('{id}'), array($this->id), '/api/v1/software/{id}');
    }
