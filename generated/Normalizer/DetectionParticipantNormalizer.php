...
class DetectionParticipantNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'ExtraHop\\Api\\Model\\DetectionParticipant';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'ExtraHop\\Api\\Model\\DetectionParticipant';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \ExtraHop\Api\Model\DetectionParticipant();
        ...
        if (\array_key_exists('external', $data)) {
            $object->setExternal($data['external']);
        }
        return $object;
    }
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if (null !== $object->getExternal()) {
            $data['external'] = $object->getExternal();
        }
        return $data;
    }
}